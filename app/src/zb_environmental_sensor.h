...
#define ENVIRONMENTAL_SENSOR_ATTR_HUMIDITY_TOLERANCE                                               \
	(SENSOR_HUMIDITY_PERCENT_TOLERANCE * ZCL_HUMIDITY_MEASUREMENT_MEASURED_VALUE_MULTIPLIER)
...
#define ZB_HA_ENVIRONMENTAL_SENSOR_IN_CLUSTER_NUM  4
/* Identify */
#define ZB_HA_ENVIRONMENTAL_SENSOR_OUT_CLUSTER_NUM 1

/* Temperature, humidity */
#define ZB_HA_ENVIRONMENTAL_SENSOR_REPORT_ATTR_COUNT 2

#define ZB_HA_DECLARE_ENVIRONMENTAL_SENSOR_CLUSTER_LIST(                                           \
	cluster_list_name, basic_attr_list, identify_client_attr_list, identify_server_attr_list,  \
	temperature_measurement_attr_list, humidity_measurement_attr_list)                         \
